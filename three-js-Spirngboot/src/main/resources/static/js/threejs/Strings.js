...
var Strings = function ( config ) {
	...
	var values = {
		...
		zh: {
			...
			'sidebar/geometry/tube_geometry/path': '管体分段',
			'sidebar/geometry/tube_geometry/radius': '半径',
			'sidebar/geometry/tube_geometry/tube': '管状体',
			'sidebar/geometry/tube_geometry/tubularsegments': '管分段',
			'sidebar/geometry/tube_geometry/radialsegments': '径向分段',
			'sidebar/geometry/tube_geometry/closed': '紧密',
			'sidebar/geometry/tube_geometry/curvetype': '曲线类型',
			'sidebar/geometry/tube_geometry/tension': '拉紧',
