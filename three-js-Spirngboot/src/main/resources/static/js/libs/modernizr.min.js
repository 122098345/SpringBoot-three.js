window.Modernizr = (function(A, c, g) {
	var I = "2.6.2",
		...
		e = [],
		k = e.slice,
		s, n = function(U, W, O, V) {
			var N, T, Q, R, M = c.createElement("div"),
				S = c.body,
				P = S || c.createElement("body");
			if (parseInt(O, 10)) {
				while (O--) {
	...
	function m(Q, M, P) {
		var N = Q.charAt(0).toUpperCase() + Q.slice(1),
			O = (Q + " " + F.join(N + " ") + N).split(" ");
	...
	l.touch = function() {
		...
		if (("ontouchstart" in A) || A.DocumentTouch && c instanceof DocumentTouch) {
			...
			n(["@media (", j.join("touch-enabled),("), a, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(
				N) {
				M = N.offsetTop === 9
			})
		}
	...
	l.csstransforms3d = function() {
		...
		if (M && "webkitPerspective" in L.style) {
			n("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(N,
				O) {
	...
	l.fontface = function() {
		...
		n('@font-face {font-family:"font";src:url("https://")}', function(Q, R) {
			var P = c.getElementById("smodernizr"),
			...
			for (var O = 0, N, R, Q, M = P.length; O < M; O++) {
				...
				if (N) {
					...
					if (/^range$/.test(R) && K.style.WebkitAppearance !== g) {
						L.appendChild(K);
						Q = c.defaultView;
						N = Q.getComputedStyle && Q.getComputedStyle(K, null).WebkitAppearance !== "textfield" && (K.offsetHeight !==
							0);
						L.removeChild(K)
					} else {
						if (/^(search|tel)$/.test(R)) {} else {
							if (/^(url|email)$/.test(R)) {
	...
	(function(V, X) {
		...
		(function() {
			try {
				...
				Q = ae.childNodes.length == 1 || (function() {
					...
					return (typeof ag.cloneNode == "undefined" || typeof ag.createDocumentFragment == "undefined" || typeof ag.createElement ==
						"undefined")
				}())
			} catch (af) {
				ab = true;
		...
		function R(ae, ag) {
			var ah = ae.createElement("p"),
				af = ae.getElementsByTagName("head")[0] || ae.documentElement;
		...
		function ad(ae, af) {
			...
			ae.createDocumentFragment = Function("h,f",
				"return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + W().join().replace(/\w+/g,
					function(ag) {
						af.createElem(ag);
						af.frag.createElement(ag);
						return 'c("' + ag + '")'
					}) + ");return n}")(U, af.frag)
		}
...
(function(ad, ac, ab) {
	...
	function V(w, v, t, s, q, p, n) {
		...
		1 === D[v] && (b = 1, D[v] = []), "object" == w ? h.data = v : (h.src = v, h.type = w), h.width = h.height = "0", h.onerror =
	...
	function U(g, e, j, i, h) {
		return M = 0, e = e || "j", Z(g) ? V("c" == e ? G : H, g, e, this.i++, j, i, h) : (O.splice(this.i++, 0, g), 1 == O.length &&
			W()), this
	}
	...
	L = function(e) {
		...
		function n(b, s, r, q, p) {
			var o = c(b),
				l = o.autoCallback;
			o.url.split(".").pop().split("?").shift(), o.bypass || (s && (s = aa(s) ? s : s[b] || s[q] || s[b.split("/").pop()
				.split("?")[0]]), o.instead ? o.instead(b, s, r, q, p) : (D[o.url] ? o.noexec = !0 : D[o.url] = 1, r.load(o.url,
				o.forceCSS || !o.forceJS && "css" == o.url.split(".").pop().split("?").shift() ? "c" : ab, o.noexec, o.attrs,
				o.timeout), (aa(s) || aa(l)) && r.load(function() {
		...
		E.push(b)
	}, L.errorTimeout = 10000, null == ac.readyState && ac.addEventListener && (ac.readyState = "loading", ac.addEventListener(
		"DOMContentLoaded", N = function() {
